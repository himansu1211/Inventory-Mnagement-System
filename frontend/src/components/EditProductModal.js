...
const EditProductModal = ({ product, onClose, onSuccess, showToast }) => {
  ...
  useEffect(() => {
    ...
    if (product) {
      setFormData({
        ...
        price: product.price || '',
        purchasing_price: product.purchasing_price || 0,
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 p-3 bg-green-50 rounded-lg">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-green-600">${profit}</span>
              </div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
